...
<fmt:message bundle="${loc}" key="local.favourite" var="favourite"/>
<fmt:message bundle="${loc}" key="local.favourite.no_products_in_favourite" var="no_product_in_favourite"/>
    ...
    <section class="py-5 text-center container">
        <div class="row py-lg-5">
            <div class="col-lg-6 col-md-8 mx-auto">
                <h1 class="font-weight-light">${favourite}</h1>
                <p>
